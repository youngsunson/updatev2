...
টেক্সটের প্রতিটি শব্দ ও বাক্যাংশ বিশ্লেষণ করুন।
কাঙ্ক্ষিত টোনে নেই এমন শব্দগুলো চিহ্নিত করুন।
"position" ফিল্ডে সেই শব্দের 0-based word index দিন; ইনপুট টেক্সটকে স্পেস/নতুন লাইনে ভাগ করে ধারাবাহিকভাবে গুনবেন।
গুরুত্বপূর্ণ: "current" ফিল্ডে শব্দটি হুবহু ইনপুট টেক্সট থেকে কপি করবেন (কোনো পরিবর্তন ছাড়া)।
...
<div className="header-section"> <div className="header-top"> {/* বাম পাশে মেনু বাটন */} <button className="menu-btn header-menu-btn" onClick={() => setActiveModal('mainMenu')} title="মেনু" > ☰ </button>
text
...
</div> <div className="toolbar"> <div className="toolbar-top"> {/* শুধু পরীক্ষা বাটন, ডান দিকে */} <button onClick={checkSpelling} disabled={isLoading} className="btn-check" > {isLoading ? '...' : '🔍 পরীক্ষা করুন'} </button> </div>
text
